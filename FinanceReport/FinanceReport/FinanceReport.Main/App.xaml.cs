...
using FinanceReport.Main.Properties;
using FinanceReport.Main.ViewModels;
using FinanceReport.Main.Views;
using FinanceReport.Modules.ViewModels;
using FinanceReport.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = FinanceReport.Common.Modules;

namespace FinanceReport.Main
{
